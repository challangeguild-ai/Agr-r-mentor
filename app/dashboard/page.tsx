...
export default async function DashboardPage(){
  ...
  return <div className="app-shell farmer-app"><Sidebar active="dashboard"/><main className="dashboard farmer-dashboard">
    <header className="portal-topbar"><div><span className="eyebrow">AGRÁR MENTOR</span><h1>Kezdőlap</h1><p>Üdvözöljük, {name}! Itt látja a gazdasága aktuális állapotát.</p></div><div className="portal-top-actions"><NotificationBell/><div className="portal-profile"><span>{name.slice(0,2).toUpperCase()}</span><strong>{name}</strong></div><LogoutButton className="portal-top-logout"/></div></header>
