...
export function AdvisorSidebar(){
  ...
  return <>
    ...
    <aside className={`${styles.sidebar} ${open?styles.open:""}`}>
      ...
      <div className={styles.help}><strong>Mai szakmai munka</strong><small>Szemlék, feladatok, látogatások és beérkező jelzések egy helyen.</small><Link onClick={()=>setOpen(false)} href="/admin/workday">Munkanap megnyitása</Link></div>
