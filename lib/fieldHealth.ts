...
export function evaluateFieldHealth({inspection,tasks=[],reports=[],supervision,now=new Date()}:{inspection?:HealthInspection|null;tasks?:HealthTask[];reports?:HealthReport[];supervision?:SupervisionConfig|null;now?:Date}):FieldHealth{
